...
class ReactIntro extends React.Component {
  ...
  initializeState = () => {
    // Here we set the state object to have values according to the instructions
    this.setState({
      initialized: true,
  ...
  render() {
    ...
    const { initialized, productName, productDescription, productPrice } = this.state;

    // Use string interpolation to construct the sentence
